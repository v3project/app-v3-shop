                        ...
                        <? foreach (\Yii::$app->shop->cart->shopBaskets as $shopBasket) : ?>
                            ...
                            <div class="item">
                                <div class="cart_img pull-left width-100 padding-10 text-left">
                                    <img src="<?= \skeeks\cms\helpers\Image::getSrc($shopBasket->product->cmsContentElement->image->src) ?>"
                                         alt="" width="80"/>
                                </div>
                                ...
                                <div class="total_price">
                                    <span><?= \Yii::$app->money->intlFormatter()->format($shopBasket->money); ?></span>
                                </div>
                                <div class="qty">
                        ...
                        <div class="toggle-content" style="display: block;">
                            ...
                            <form action="#" method="post" class="nomargin">
                                <input type="text" id="cart-code" name="cart-code"
                                       class="form-control text-center margin-bottom-10" placeholder="Код купона"
                                       required="required">
                ...
                <div class="toggle-transparent toggle-bordered-full clearfix">
                    <div class="toggle active" style="display: block;">
                        <div class="toggle-content" style="display: block;">
                            ...
                            <a href="<?= \yii\helpers\Url::to(['/shop/cart/checkout']); ?>"
