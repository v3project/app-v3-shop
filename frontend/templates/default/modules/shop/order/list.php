    ...
    <?= \yii\grid\GridView::widget([
        ...
        "columns" => [
            ...
            [
                ...
                'format' => 'raw',
                'filter' => \yii\helpers\ArrayHelper::map(\skeeks\cms\shop\models\ShopOrderStatus::find()->all(),
                    'code', 'name'),
...
HTML;
            ...
            [
                ...
                'format' => 'raw',
                'value' => function (\skeeks\cms\shop\models\ShopOrder $model) {
                    return \yii\helpers\Html::a('Подробнее...',
                        \yii\helpers\Url::to(['/shop/order/view', 'id' => $model->id]),
                        ['class' => 'btn btn-default btn-primary product-add-cart noradius']);
                },
                'options' => array('style' => 'text-align: center;')
            ],
