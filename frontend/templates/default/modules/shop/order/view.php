                ...
                <?= \yii\widgets\DetailView::widget([
                    ...
                    'attributes' => [
                        ...
                        [                      // the owner name of the model
                            'label' => 'Статус',
                            'format' => 'raw',
                            'value' => Html::tag('span', $model->status->name,
                ...
                <? foreach ($model->shopBaskets as $shopBasket) : ?>
                    ...
                    <div class="item">
                        <div class="cart_img pull-left width-100 padding-10 text-left">
                            <img src="<?= \skeeks\cms\helpers\Image::getSrc($shopBasket->image ? $shopBasket->image->src : null); ?>"
                                 alt="<?= $shopBasket->product->cmsContentElement->name; ?> title="<?= $shopBasket->product->cmsContentElement->name; ?>
                                 width="80"/>
                        </div>
                        <a href="<?= $shopBasket->product->cmsContentElement->url; ?>" class="product_name"
                           data-pjax="0">
                            <span><?= $shopBasket->product->cmsContentElement->name; ?></span>
                            <!--<small>Color: Brown, Size: XL</small>-->
                        </a>
                        <div class="total_price">
                            <span><?= \Yii::$app->money->convertAndFormat($shopBasket->money); ?></span></div>
                        <div class="qty">
