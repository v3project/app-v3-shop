...
<li>
    <div class="info">
        <div class="info--num"><a href="<?=\yii\helpers\Url::to(['/v3toys/order/view', 'id' => $model->id])?>">№<?= $model->id; ?></a></div>
        <div class="info--date">от <?= \Yii::$app->formatter->asDatetime($model->created_at); ?></div>
    </div>
    <div class="status"><?= $model->v3toys_status_id ? $model->status->name : ""; ?></div>
    <div class="price"><span class="num"><?= \Yii::$app->money->convertAndFormat($model->money); ?></span> <!--<span class="rb">руб.</span>--></div>
</li>
<!--
